...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 11 Mai 2017 à 08:16
...
--
-- Base de données :  `eval_kids_test`
--
...
(3, 'Rue maréchal leclerc', NULL, 'Saint-Denis', '97400');
...
(2, 'CSS', 'Debuter avec CSS', '12.00', 20, '1.jpg', 1, 1, 1, 2);
...
--
ALTER TABLE `establishment`
  ADD CONSTRAINT `fk_establishment_address1` FOREIGN KEY (`address_id`) REFERENCES `address` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Contraintes pour la table `kid_has_parent`
--
ALTER TABLE `kid_has_parent`
  ADD CONSTRAINT `fk_kid_has_parent_kid1` FOREIGN KEY (`kid_id`) REFERENCES `kid` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_kid_has_parent_parent1` FOREIGN KEY (`parent_id`) REFERENCES `parent` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Contraintes pour la table `parent`
--
ALTER TABLE `parent`
  ADD CONSTRAINT `fk_parent_address1` FOREIGN KEY (`address_id`) REFERENCES `address` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Contraintes pour la table `timetable`
--
ALTER TABLE `timetable`
  ADD CONSTRAINT `fk_timetable_workshop1` FOREIGN KEY (`workshop_id`) REFERENCES `workshop` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Contraintes pour la table `workshop`
--
ALTER TABLE `workshop`
  ADD CONSTRAINT `fk_workshop_establishment1` FOREIGN KEY (`establishment_id`) REFERENCES `establishment` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_workshop_public_age` FOREIGN KEY (`public_age_id`) REFERENCES `public_age` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_workshop_workshop_category1` FOREIGN KEY (`workshop_category_id`) REFERENCES `workshop_category` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Contraintes pour la table `workshop_has_kid`
--
ALTER TABLE `workshop_has_kid`
  ADD CONSTRAINT `fk_workshop_has_kid_kid1` FOREIGN KEY (`kid_id`) REFERENCES `kid` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_workshop_has_kid_workshop1` FOREIGN KEY (`workshop_id`) REFERENCES `workshop` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
